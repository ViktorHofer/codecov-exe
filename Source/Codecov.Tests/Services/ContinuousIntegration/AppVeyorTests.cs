...
namespace Codecov.Services.ContinuousIntegration
{
    ...
    {
        [Fact]
        public void Branch_Should_Be_Null_String_When_Enviornment_Variable_Does_Not_Exits()
        {
            // Given
        ...
        [Fact]
        public void Build_Should_Be_Null_String_When_Enviornment_Variable_Does_Not_Exits()
        {
            // Given
        ...
        [Fact]
        public void Commit_Should_Be_Null_String_When_Enviornment_Variable_Does_Not_Exits()
        {
            // Given
        ...
        [Theory, InlineData(null, null), InlineData("", ""), InlineData("True", null), InlineData("True", ""), InlineData(null, "True"), InlineData("", "True"), InlineData("False", "True"), InlineData("True", "False"), InlineData("False", "False"), InlineData("foo", "bar")]
        ...
        [Fact]
        public void Exists_Should_Be_True_When_AppVeyor_Enviornment_Variable_And_Ci_Enviornment_Variable_Exit_And_Both_Are_Equal_To_True()
        {
            // Given
        ...
        public void Job_Should_Be_Null_String_When_Enviornment_Variables_Do_Not_Exit(string accountData, string slugData, string versionData)
        {
            // Given
        ...
        [Fact]
        public void PR_Should_Be_Null_String_When_Enviornment_Variable_Does_Not_Exits()
        {
            // Given
        ...
        [Fact]
        public void Slug_Should_Be_Null_String_When_Enviornment_Variable_Does_Not_Exits()
        {
            // Given
