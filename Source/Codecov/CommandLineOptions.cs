...
namespace Codecov
{
    ...
    public class CommandLineOptions
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether to print the Codecov-Exe logo.
        /// </summary>
        /// <value>A value indicating whether to print the Codecov-Exe logo.</value>
        [Option("no-logo", HelpText = "Don't output the Codecov-exe logo.")]
        ...
        /// <summary>
        /// Gets or sets the relative path to the codecov yaml file in the repository.
        /// Useful when not in git/hg project.
        /// </summary>
        /// <value>
        /// The relative path to the codecov yaml file in the repository. Useful when not in
        /// git/hg project.
        /// </value>
        [Option("yaml", HelpText = "Set the relative path to the yaml file in the repository. Useful when not in git/hg project.")]
