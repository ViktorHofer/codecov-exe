...
namespace Codecov.Coverage.Report
{
    internal class Report : IReport
    {
        ...
        public Report(IReportOptions options, IEnviornmentVariables environmentVariables, ISourceCode sourceCode, ICoverage coverage)
        {
        ...
        private IEnviornmentVariables EnvironmentVariables { get; }
