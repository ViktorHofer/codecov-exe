...
namespace Codecov.Services.ContinuousIntegrationServers
{
    ...
    {
        private readonly Lazy<string> _build = new Lazy<string>(() => EnviornmentVariable.GetEnvironmentVariable("CI_BUILD_ID"));
        private readonly Lazy<string> _buildUrl = new Lazy<string>(() => EnviornmentVariable.GetEnvironmentVariable("CI_BUILD_URL"));
        private readonly Lazy<string> _job = new Lazy<string>(() => EnviornmentVariable.GetEnvironmentVariable("CI_JOB_ID"));
