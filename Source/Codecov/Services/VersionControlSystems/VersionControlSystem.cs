...
namespace Codecov.Services.VersionControlSystems
{
    ...
    {
        private readonly Lazy<string> _branch = new Lazy<string>(() => EnviornmentVariable.GetEnvironmentVariable("VCS_BRANCH_NAME"));
        private readonly Lazy<string> _commit = new Lazy<string>(() => EnviornmentVariable.GetEnvironmentVariable("VCS_COMMIT_ID"));
        private readonly Lazy<string> _pr = new Lazy<string>(() => EnviornmentVariable.GetEnvironmentVariable("VCS_PULL_REQUEST"));
        private readonly Lazy<string> _repoRoot;
        private readonly Lazy<string> _slug = new Lazy<string>(() => EnviornmentVariable.GetEnvironmentVariable("VCS_SLUG"));
        private readonly Lazy<IEnumerable<string>> _sourceCode;
        private readonly Lazy<string> _tag = new Lazy<string>(() => EnviornmentVariable.GetEnvironmentVariable("VCS_TAG"));
